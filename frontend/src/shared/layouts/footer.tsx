...
const Footer = () => {
  return (
    <footer className="bg-gray-50 px-10 pb-6 pt-12 tracking-wide">
      <div className="flex flex-wrap justify-between gap-10">
        <div className="max-w-md">
          ...
          <div className="mt-4">
            <p className="text-sm leading-relaxed text-gray-600">
              ...
              fringilla, nunc et facilisis tincidunt, nunc nisl aliquet nunc,
              eget aliquam nisl nunc eget erat.
            </p>
          </div>
        ...
        <div className="max-lg:min-w-[140px]">
          <h4 className="relative text-base font-semibold text-gray-800 max-sm:cursor-pointer">
            Services
          </h4>
      ...
      <div className="flex flex-wrap gap-4 max-md:flex-col">
        <ul className="max-md:space-y-2 md:flex md:space-x-6">
          <li>
            <a
              href="javascript:void(0)"
              className="text-sm text-gray-600 hover:text-gray-800"
