  ...
  const handleToggleLessonPublish = (lessonId: string) => {
    toggleLessonPublishMutation.mutate(lessonId, {
      onSuccess: (updatedLesson) => {
        toast.success(`Bài học đã được ${updatedLesson.isPublished ? 'công khai' : 'ẩn'} thành công`)
      },
      onError: () => {
    ...
    <div className='container mx-auto space-y-6 py-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='mt-1 text-gray-600'>Quản lý nội dung khóa học của bạn</p>
        </div>
        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className='p-12 text-center'>
              ...
              <h3 className='mb-2 text-lg font-semibold text-gray-600'>Chưa có chương nào</h3>
              <p className='mb-6 text-gray-500'>Bắt đầu bằng cách tạo chương đầu tiên</p>
              <Button onClick={handleAddChapter}>
                <MdAdd className='mr-2 h-4 w-4' />
          ...
          >
            ...
            <DragOverlay>
              {activeId ? (
                <div className='rounded-xs border border-blue-500 bg-white p-4 shadow-lg'>
