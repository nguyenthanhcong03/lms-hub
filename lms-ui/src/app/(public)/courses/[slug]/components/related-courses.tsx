  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 gap-3 sm:gap-4">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Khóa học liên quan</h2>
          <p className="text-sm sm:text-base text-gray-600">Các khóa học thường được mua cùng với khóa học này</p>
        </div>
